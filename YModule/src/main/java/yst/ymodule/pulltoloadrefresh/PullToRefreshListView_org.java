...
public class PullToRefreshListView_org extends ListView implements OnScrollListener {
    ...
    private ProgressView mRefreshViewProgress;
    ...
    public PullToRefreshListView_org(Context context) {
        super(context);
        init(context);
    }

    public PullToRefreshListView_org(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    protected void init(Context context) {
        ...
        mRefreshViewText = mRefreshView
                .findViewById(R.id.pull_to_refresh_text);
        mRefreshViewImage = mRefreshView
                .findViewById(R.id.pull_to_refresh_image);
        mRefreshViewProgress = mRefreshView
                .findViewById(R.id.pull_to_refresh_progress);
        mRefreshViewLastUpdated = mRefreshView
    ...
    public interface OnRefreshListener {
         ...
         * <p/>
         * A call to {@link yst.ymodule.pulltoloadrefresh.PullToRefreshListView #onRefreshComplete()} is
