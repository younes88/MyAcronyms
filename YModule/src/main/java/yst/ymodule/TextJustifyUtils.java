...
public class TextJustifyUtils { // Please use run(...) instead
    ...
    public static void justify(TextView textView, int toRemove) {
        ...
        textWrapWidth = textView.getWidth() - toRemove;
    ...
    public static void Simplejustify(final TextView textView) {
        textView.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (!isJustified) {
                    TextJustifyUtils.justify(textView, 0);
                    isJustified = true;
                }
    ...
    public static void Simplejustify(final TextView textView, final int toRemove) {
        textView.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            boolean isJustified = false;
            ...
            public boolean onPreDraw() {
                if (!isJustified) {
                    TextJustifyUtils.justify(textView, toRemove);
                    isJustified = true;
                }
